...
**Female= 9.97**
**Male= 10.91**
Thus, Male students achieved a slightly higher average final grade in this dataset.
...
git clone https://github.com/Sreya250105/Data-Science-And-Data-Analytics-Using-Python
...
5. Open student_analysis.ipynb and run all the cells.
